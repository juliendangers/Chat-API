<?php
/**
 * Auto generated from LocalStorageProtocol.proto at 2016-07-11 18:00:56
 *
 * textsecure package
 */

namespace Textsecure\SessionStructure\Chain {
    /**
...
namespace Textsecure\SessionStructure {
    /**
    ...
    class Chain extends \ProtobufMessage
    {
        ...
        protected static $fields = array(
            ...
            self::CHAINKEY => array(
                'name' => 'chainKey',
                'required' => false,
                'type' => '\Textsecure\SessionStructure\Chain\ChainKey'
            ),
            self::MESSAGEKEYS => array(
                'name' => 'messageKeys',
                'repeated' => true,
                'type' => '\Textsecure\SessionStructure\Chain\MessageKey'
            ),
        );
         ...
         *
         * @param \Textsecure\SessionStructure\Chain\ChainKey $value Property value
         *
         * @return null
         */
        public function setChainKey(\Textsecure\SessionStructure\Chain\ChainKey $value)
        {
         ...
         *
         * @return \Textsecure\SessionStructure\Chain\ChainKey
         */
         ...
         *
         * @param \Textsecure\SessionStructure\Chain\MessageKey $value Value to append
         *
         * @return null
         */
        public function appendMessageKeys(\Textsecure\SessionStructure\Chain\MessageKey $value)
        {
         ...
         *
         * @return \Textsecure\SessionStructure\Chain\MessageKey[]
         */
    ...
    class SessionStructure extends \ProtobufMessage
    {
        ...
        protected static $fields = array(
            ...
            self::SENDERCHAIN => array(
                'name' => 'senderChain',
                'required' => false,
                'type' => '\Textsecure\SessionStructure\Chain'
            ),
            ...
            self::PENDINGKEYEXCHANGE => array(
                ...
                'required' => false,
                'type' => '\Textsecure\SessionStructure\PendingKeyExchange'
            ),
            self::PENDINGPREKEY => array(
                'name' => 'pendingPreKey',
                'required' => false,
                'type' => '\Textsecure\SessionStructure\PendingPreKey'
            ),
         ...
         *
         * @param \Textsecure\SessionStructure\Chain $value Property value
         *
         * @return null
         */
        public function setSenderChain(\Textsecure\SessionStructure\Chain $value)
        {
         ...
         *
         * @return \Textsecure\SessionStructure\Chain
         */
         ...
         *
         * @param \Textsecure\SessionStructure\Chain $value Value to append
         *
         * @return null
         */
        public function appendReceiverChains(\Textsecure\SessionStructure\Chain $value)
        {
         ...
         *
         * @param \Textsecure\SessionStructure\PendingKeyExchange $value Property value
         *
         * @return null
         */
        public function setPendingKeyExchange(\Textsecure\SessionStructure\PendingKeyExchange $value)
        {
         ...
         *
         * @return \Textsecure\SessionStructure\PendingKeyExchange
         */
         ...
         *
         * @param \Textsecure\SessionStructure\PendingPreKey $value Property value
         *
         * @return null
         */
        public function setPendingPreKey(\Textsecure\SessionStructure\PendingPreKey $value)
        {
         ...
         *
         * @return \Textsecure\SessionStructure\PendingPreKey
         */
    ...
    class RecordStructure extends \ProtobufMessage
    {
        ...
        protected static $fields = array(
            self::CURRENTSESSION => array(
                'name' => 'currentSession',
                'required' => false,
                'type' => '\Textsecure\SessionStructure'
            ),
         ...
         *
         * @param \Textsecure\SessionStructure $value Property value
         *
         * @return null
         */
        public function setCurrentSession(\Textsecure\SessionStructure $value)
        {
         ...
         *
         * @return \Textsecure\SessionStructure
         */
         ...
         *
         * @param \Textsecure\SessionStructure $value Value to append
         *
         * @return null
         */
        public function appendPreviousSessions(\Textsecure\SessionStructure $value)
        {
...
namespace Textsecure\SenderKeyStateStructure {
    /**
    ...
    class SenderKeyStateStructure extends \ProtobufMessage
    {
        ...
        protected static $fields = array(
            ...
            self::SENDERCHAINKEY => array(
                'name' => 'senderChainKey',
                'required' => false,
                'type' => '\Textsecure\SenderKeyStateStructure\SenderChainKey'
            ),
            self::SENDERSIGNINGKEY => array(
                'name' => 'senderSigningKey',
                'required' => false,
                'type' => '\Textsecure\SenderKeyStateStructure\SenderSigningKey'
            ),
            self::SENDERMESSAGEKEYS => array(
                'name' => 'senderMessageKeys',
                'repeated' => true,
                'type' => '\Textsecure\SenderKeyStateStructure\SenderMessageKey'
            ),
        );
         ...
         *
         * @param \Textsecure\SenderKeyStateStructure\SenderChainKey $value Property value
         *
         * @return null
         */
        public function setSenderChainKey(\Textsecure\SenderKeyStateStructure\SenderChainKey $value)
        {
         ...
         *
         * @return \Textsecure\SenderKeyStateStructure\SenderChainKey
         */
         ...
         *
         * @param \Textsecure\SenderKeyStateStructure\SenderSigningKey $value Property value
         *
         * @return null
         */
        public function setSenderSigningKey(\Textsecure\SenderKeyStateStructure\SenderSigningKey $value)
        {
         ...
         *
         * @return \Textsecure\SenderKeyStateStructure\SenderSigningKey
         */
         ...
         *
         * @param \Textsecure\SenderKeyStateStructure\SenderMessageKey $value Value to append
         *
         * @return null
         */
        public function appendSenderMessageKeys(\Textsecure\SenderKeyStateStructure\SenderMessageKey $value)
        {
         ...
         *
         * @return \Textsecure\SenderKeyStateStructure\SenderMessageKey[]
         */
    ...
    class SenderKeyRecordStructure extends \ProtobufMessage
    {
        ...
        protected static $fields = array(
            self::SENDERKEYSTATES => array(
                ...
                'repeated' => true,
                'type' => '\Textsecure\SenderKeyStateStructure'
            ),
        );
         ...
         *
         * @param \Textsecure\SenderKeyStateStructure $value Value to append
         *
         * @return null
         */
        public function appendSenderKeyStates(\Textsecure\SenderKeyStateStructure $value)
        {
         ...
         *
         * @return \Textsecure\SenderKeyStateStructure[]
         */
