...
class SignedPreKeyRecord
{
    ...
    public function __construct($id = null, $timestamp = null, ECKeyPair $keyPair = null, $signature = null, $serialized = null) // [int id, long timestamp, ECKeyPair keyPair, byte[] signature]
    {
